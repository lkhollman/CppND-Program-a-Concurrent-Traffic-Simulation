...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if(_trafficLight.getCurrentPhase() != TrafficLightPhase::green){  //I added  
        _trafficLight.waitForGreen();   // I added
    }
...
void Intersection::simulate() // using threads + promises/futures + exceptions
{
    ...
    _trafficLight.simulate();  //I added this
...
bool Intersection::trafficLightIsGreen()
{
   ...
   //I uncommented this entire if/else block
